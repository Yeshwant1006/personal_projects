...
def send_email(send_from, send_to, subject, text, files=None):
    ...
    smtp.starttls()
    smtp.login(send_from, 'yesh@10061998')
...
if __name__=="__main__":
    ...
    send_email('yeshkoltur@gmail.com', ['rishi.kolthuru@gmail.com', 'yeshwanth.kolthuru@gmail.com'], 'Jobs Posting', 'na', files = ['remote_jobs.xls'])